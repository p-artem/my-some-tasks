<div class="span-8 last">
    ...
    <?php if(is_page(2)): ?>
        <ul>
            <li><img src="<?=bloginfo('template_directory'); ?>/LOGO/logo.png" alt="logo" width="300px"/></li>
        </ul>
    <?php endif; ?>
    ...
    <?php if(get_theme_option('video') != '') {
            ...
            <?php if(is_single(30)): ?>
                <div class="sidebarvideo">
            			<ul><li>
            			<iframe width="290" height="220" src="https://www.youtube.com/embed/8xOsgHJERjM" frameborder="0" allowfullscreen></iframe>
            			</li>
            			</ul>
            		</div>
            <?php endif; ?>
