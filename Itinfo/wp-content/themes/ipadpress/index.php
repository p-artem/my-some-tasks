		...
		<div class="span-24" id="contentwrap">
			<div class="span-16">
                ...
                <?php if(is_home()) { include (TEMPLATEPATH . '/featured.php'); } ?>		
					<?php if (have_posts()) : ?>	
						...
						<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
							...
							<div class="entry">
								<?php the_content('<strong>Далее &raquo;</strong>'); ?>
							</div>
						</div><!--/post-<?php the_ID(); ?>-->
				...
				<?php else : ?>
					...
					<p class="center">Извините, ничего не нашлось. Воспользуйтесь навигацией или поиском, чтобы найти необходимую вам информацию.</p>
					<?php get_search_form(); ?>
