			...
			<div id="myGallery">
				...
				if($featured_posts_category != '' && $featured_posts_category != '0') {
					...
					for($i = 1; $i <=5; $i++) {
						?>
							<div class="imageElement">
								<h3>Это заголовок лучшей записи <?php echo $i; ?> </h3>
								<p>Вы можете выбрать лучшие записи на странице настроек темы оформления в админ-панели. Вы также можете отключить отображение слайдера с лучшими записями.</p>
								<a href="#" title="Лучшая запись <?php echo $i; ?>" class="open"></a> 
